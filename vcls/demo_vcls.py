...
if __name__ == '__main__':
    ...
    mj.slice_viewer(reference_object, recon_uniform, recon_optimal_angles, slice_label=['Ground Truth', 'Uniform Angles', 'VCLS Angles'], title='Ground truth (left) vs \nRecon from uniformly spaced angles (middle) \nand optimal angles (right)')
